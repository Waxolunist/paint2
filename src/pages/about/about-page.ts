  ...
  render(): TemplateResult {
    return html`
      <section>
        ...
        <p>
          All of the revenue will go to charity. Twice a year I will publish
          here the revenue numbers and which charity facilities I support.
          Servers and cost of operations I'll pay from my own pocket.
        </p>
        <p>
        ...
        <p>
          I created the app as a pet project to learn more about web application
          programing, but published it to generate some revenue for charity.
        </p>
        <h2>Privacy policy</h2>
        <p>see <a href="/privacy">here</a>.</p>
        <dl>
          <dt>Github</dt>
          <dd>
